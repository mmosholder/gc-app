...
var LOGIN_MUTATION = __WEBPACK_IMPORTED_MODULE_0_graphql_tag___default()(_templateObject);
  ...
  methods: {
    logIn: function logIn(email, password) {
      this.$apollo.mutate({
        ...
        __WEBPACK_IMPORTED_MODULE_1_store___default.a.set('token', { token: r.data.logIn });
                    ...
                    "button",
                    {
                      ...
                      on: {
                        click: function($event) {
                          ...
                          _vm.logIn(_vm.email, _vm.password)
                        }
                      }
                    },
                    [_vm._v("Sign me up!")]
